...
public class SubAreaReferencesSystem : GameSystemBase
{
	...
	private struct UpdateSubAreaReferencesJob : IJobChunk
	{
		...
		public void Execute(in ArchetypeChunk chunk, int unfilteredChunkIndex, bool useEnabledMask, in v128 chunkEnabledMask)
		{
			...
			if (((ArchetypeChunk)(ref chunk)).Has<Created>(ref m_CreatedType))
			{
				if (((ArchetypeChunk)(ref chunk)).Has<Temp>(ref m_TempType))
				{
					for (int i = 0; i < nativeArray2.Length; i++)
					{
						...
						{
							CollectionUtils.TryAddUniqueValue<SubArea>(m_SubAreas[owner.m_Owner], new SubArea(nativeArray[i]));
						}
					}
					return;
				}
			...
			for (int k = 0; k < nativeArray.Length; k++)
			{
				...
				{
					CollectionUtils.RemoveValue<SubArea>(m_SubAreas[owner3.m_Owner], new SubArea(area2));
				}
			}
		}
	...
	protected override void OnCreate()
	{
		...
		array[0] = val;
		m_SubAreaQuery = ((ComponentSystemBase)this).GetEntityQuery((EntityQueryDesc[])(object)array);
		((ComponentSystemBase)this).RequireForUpdate(m_SubAreaQuery);
	}
	...
	protected override void OnUpdate()
	{
		...
		UpdateSubAreaReferencesJob updateSubAreaReferencesJob = new UpdateSubAreaReferencesJob
		{
		...
		((SystemBase)this).Dependency = JobChunkExtensions.Schedule<UpdateSubAreaReferencesJob>(updateSubAreaReferencesJob, m_SubAreaQuery, ((SystemBase)this).Dependency);
	}
