...
public class PostVehicleSection : VehicleSection
{
	...
	private bool Visible()
	{
		...
		if (((EntityManager)(ref entityManager)).HasComponent<Vehicle>(selectedEntity))
		{
			...
			if (((EntityManager)(ref entityManager)).HasComponent<PostVan>(selectedEntity))
			{
				entityManager = ((ComponentSystemBase)this).EntityManager;
	...
	protected override void OnProcess()
	{
		...
		EntityManager entityManager = ((ComponentSystemBase)this).EntityManager;
		PostVan componentData = ((EntityManager)(ref entityManager)).GetComponentData<PostVan>(selectedEntity);
