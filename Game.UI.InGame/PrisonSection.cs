...
public class PrisonSection : InfoSectionBase
{
	...
	private bool Visible()
	{
		...
		return ((EntityManager)(ref entityManager)).HasComponent<Game.Buildings.Prison>(selectedEntity);
	}
	...
	protected override void OnProcess()
	{
		...
		if (TryGetComponentWithUpgrades<PrisonData>(selectedEntity, selectedPrefab, out PrisonData data))
		{
