...
public class PhotoModeRenderSystem : GameSystemBase
{
	...
	private static readonly Vector2[] kApertureFormatValues = (Vector2[])(object)new Vector2[14]
	{
	...
	private OverridableLensProperty<GateFitMode> gateFitMode;
	...
	protected override void OnCreate()
	{
		...
		VolumeHelper.GetOrCreateVolumeComponent<ColorAdjustments>(m_CameraControlVolume, ref m_ColorAdjustments);
		VolumeHelper.GetOrCreateVolumeComponent<WhiteBalance>(m_CameraControlVolume, ref m_WhiteBalance);
		VolumeHelper.GetOrCreateVolumeComponent<PaniniProjection>(m_CameraControlVolume, ref m_PaniniProjection);
		VolumeHelper.GetOrCreateVolumeComponent<ShadowsMidtonesHighlights>(m_CameraControlVolume, ref m_ShadowsMidtonesHighlights);
		VolumeHelper.GetOrCreateVolumeComponent<Vignette>(m_CameraControlVolume, ref m_Vignette);
		VolumeHelper.GetOrCreateVolumeComponent<Bloom>(m_CameraControlVolume, ref m_Bloom);
		VolumeHelper.GetOrCreateVolumeComponent<MotionBlur>(m_CameraControlVolume, ref m_MotionBlur);
		VolumeHelper.GetOrCreateVolumeComponent<DepthOfField>(m_CameraControlVolume, ref m_DepthOfField);
		VolumeHelper.GetOrCreateVolumeComponent<CloudLayer>(m_CameraControlVolume, ref m_DistanceClouds);
		VolumeHelper.GetOrCreateVolumeComponent<VolumetricClouds>(m_CameraControlVolume, ref m_VolumetricClouds);
		VolumeHelper.GetOrCreateVolumeComponent<Fog>(m_CameraControlVolume, ref m_Fog);
		VolumeHelper.GetOrCreateVolumeComponent<PhysicallyBasedSky>(m_CameraControlVolume, ref m_Sky);
		((VolumeParameter<VignetteMode>)(object)m_Vignette.mode).Override((VignetteMode)0);
		VolumeHelper.GetOrCreateVolumeComponent<FilmGrain>(m_CameraControlVolume, ref m_FilmGrain);
		...
		sensorSize = new OverridableLensProperty<Vector2>(m_CameraUpdateSystem, delegate(IGameCameraController c, Vector2 v)
		{
			...
			((LensSettings)(ref c.lens)).SensorSize = v;
		}, (IGameCameraController c) => ((LensSettings)(ref c.lens)).SensorSize);
		...
		gateFitMode = new OverridableLensProperty<GateFitMode>(m_CameraUpdateSystem, delegate(IGameCameraController c, GateFitMode v)
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
	...
	public void Enable(bool enabled)
	{
		...
		if (m_Active)
		{
			((ComponentSystemBase)this).Enabled = enabled;
		}
	}
	...
	private void InitializeProperties()
	{
		...
		AddProperty(PhotoModeUtils.BindProperty<GateFitMode>("Camera", (Expression<Func<OverridableLensProperty<GateFitMode>>>)(() => gateFitMode), (Func<bool>)null));
		...
		AddProperty(new PhotoModeProperty
		{
			...
			getValue = () => ((Object)(object)m_CameraUpdateSystem.cinematicCameraController != (Object)null) ? m_CameraUpdateSystem.cinematicCameraController.dutch : 0f,
			min = () => -45f,
			max = () => 45f,
			reset = delegate
			{
		...
		AddProperty(PhotoModeUtils.GroupTitle("Lens", ((object)m_DepthOfField).GetType().Name));
		AddProperty(PhotoModeUtils.BindProperty<DepthOfFieldMode>("Lens", (Expression<Func<VolumeParameter<DepthOfFieldMode>>>)(() => (VolumeParameter<DepthOfFieldMode>)(object)m_DepthOfField.focusMode), (Func<bool>)null));
		AddProperty(PhotoModeUtils.BindProperty("Lens", () => m_DepthOfField.focusDistance, () => m_DepthOfField.IsActive() && (VolumeParameter<DepthOfFieldMode>)(object)m_DepthOfField.focusMode == (DepthOfFieldMode)1));
		AddProperty(PhotoModeUtils.BindProperty("Lens", () => m_DepthOfField.nearFocusStart, () => m_DepthOfField.IsActive() && (VolumeParameter<DepthOfFieldMode>)(object)m_DepthOfField.focusMode == (DepthOfFieldMode)2));
		AddProperty(PhotoModeUtils.BindProperty("Lens", () => m_DepthOfField.nearFocusEnd, () => m_DepthOfField.IsActive() && (VolumeParameter<DepthOfFieldMode>)(object)m_DepthOfField.focusMode == (DepthOfFieldMode)2));
		AddProperty(PhotoModeUtils.BindProperty("Lens", () => m_DepthOfField.farFocusStart, () => m_DepthOfField.IsActive() && (VolumeParameter<DepthOfFieldMode>)(object)m_DepthOfField.focusMode == (DepthOfFieldMode)2));
		AddProperty(PhotoModeUtils.BindProperty("Lens", () => m_DepthOfField.farFocusEnd, () => m_DepthOfField.IsActive() && (VolumeParameter<DepthOfFieldMode>)(object)m_DepthOfField.focusMode == (DepthOfFieldMode)2));
		AddProperty(PhotoModeUtils.BindProperty("Lens", () => m_DepthOfField.m_NearMaxBlur, () => m_DepthOfField.IsActive() && (VolumeParameter<DepthOfFieldMode>)(object)m_DepthOfField.focusMode != (DepthOfFieldMode)0));
		AddProperty(PhotoModeUtils.BindProperty("Lens", () => m_DepthOfField.m_FarMaxBlur, () => m_DepthOfField.IsActive() && (VolumeParameter<DepthOfFieldMode>)(object)m_DepthOfField.focusMode != (DepthOfFieldMode)0));
		AddProperty(PhotoModeUtils.GroupTitle("Lens", ((object)m_MotionBlur).GetType().Name));
		...
		AddProperty(PhotoModeUtils.GroupTitle("Lens", ((object)m_Bloom).GetType().Name));
		...
		AddProperty(PhotoModeUtils.GroupTitle("Lens", ((object)m_Vignette).GetType().Name));
		...
		AddProperty(PhotoModeUtils.GroupTitle("Lens", ((object)m_FilmGrain).GetType().Name));
		AddProperty(PhotoModeUtils.BindProperty<FilmGrainLookup>("Lens", (Expression<Func<VolumeParameter<FilmGrainLookup>>>)(() => (VolumeParameter<FilmGrainLookup>)(object)m_FilmGrain.type), (Func<bool>)null));
		...
		AddProperty(PhotoModeUtils.GroupTitle("Lens", ((object)m_PaniniProjection).GetType().Name));
		...
		AddProperty(PhotoModeUtils.GroupTitle("Color", ((object)m_ColorAdjustments).GetType().Name));
		...
		AddProperty(PhotoModeUtils.GroupTitle("Color", ((object)m_WhiteBalance).GetType().Name));
		...
		AddProperty(PhotoModeUtils.GroupTitle("Color", ((object)m_ShadowsMidtonesHighlights).GetType().Name));
		...
		AddProperty(PhotoModeUtils.GroupTitle("Weather", ((object)m_DistanceClouds).GetType().Name));
		...
		AddProperty(PhotoModeUtils.GroupTitle("Weather", ((object)m_VolumetricClouds).GetType().Name));
		...
		AddProperty(PhotoModeUtils.BindProperty<CloudErosionNoise>("Weather", (Expression<Func<VolumeParameter<CloudErosionNoise>>>)(() => (VolumeParameter<CloudErosionNoise>)(object)m_VolumetricClouds.erosionNoiseType), (Func<bool>)null));
		...
		AddProperty(PhotoModeUtils.GroupTitle("Weather", ((object)m_Fog).GetType().Name));
		...
		AddProperty(PhotoModeUtils.GroupTitle("Weather", ((object)m_Sky).GetType().Name));
