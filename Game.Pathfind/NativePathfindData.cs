...
public struct NativePathfindData : IDisposable
{
	...
	private unsafe NativePathfindData(Allocator allocator, int disposeSentinelStackDepth)
	{
		...
		m_PathfindData = (UnsafePathfindData*)UnsafeUtility.Malloc((long)UnsafeUtility.SizeOf<UnsafePathfindData>(), UnsafeUtility.AlignOf<UnsafePathfindData>(), allocator);
		System.Runtime.CompilerServices.Unsafe.Write(m_PathfindData, new UnsafePathfindData(allocator));
	...
	public unsafe void Dispose()
	{
		...
		UnsafeUtility.Free((void*)m_PathfindData, m_AllocatorLabel);
		m_PathfindData = null;
	}
