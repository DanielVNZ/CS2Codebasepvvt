...
public struct PathInformation : IComponentData, IQueryTypeParameter, ISerializable
{
	...
	public void Deserialize<TReader>(TReader reader) where TReader : IReader
	{
		...
		if (((Context)(ref context)).version >= Version.totalPathfindCost)
		{
			ref float totalCost = ref m_TotalCost;
			((IReader)reader/*cast due to .constrained prefix*/).Read(ref totalCost);
		}
		context = ((IReader)reader).context;
		if (((Context)(ref context)).version >= Version.usedPathfindMethods)
		{
		...
		context = ((IReader)reader).context;
		if (((Context)(ref context)).version >= Version.pathfindState)
		{
