...
public static class ModificationJobs
{
	...
	public struct SetDensityJob : IJob, IPathfindModificationJob
	{
		...
		public void Execute()
		{
			...
			Enumerator<DensityActionData> enumerator = m_Action.m_DensityData.AsReadOnly().GetEnumerator();
	...
	public struct SetTimeJob : IJob, IPathfindModificationJob
	{
		...
		public void Execute()
		{
			...
			Enumerator<TimeActionData> enumerator = m_Action.m_TimeData.AsReadOnly().GetEnumerator();
			while (enumerator.MoveNext())
			{
	...
	public struct SetFlowJob : IJob, IPathfindModificationJob
	{
		...
		public void Execute()
		{
			...
			//IL_002a: Unknown result type (might be due to invalid IL or missing references)
			//IL_0052: Unknown result type (might be due to invalid IL or missing references)
			Enumerator<FlowActionData> enumerator = m_Action.m_FlowData.AsReadOnly().GetEnumerator();
			while (enumerator.MoveNext())
			{
