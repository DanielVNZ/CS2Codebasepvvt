...
public class UberZOrdererTest : MonoBehaviour
{
	...
	private void TestSmall()
	{
		...
		num2 *= 4;
		num2 *= 4;
		UberZOrderer val = new UberZOrderer(512, 512 * num, num2, 1);
		if (val.ReserveRect(1024, 4096) != 0)
		{
			throw new Exception();
		}
		int num3 = val.ReserveRect(8192, 8192);
		int num4 = val.ReserveRect(8192, 8192);
		int num5 = val.ReserveRect(8192, 8192);
		if (num3 != 1024)
		{
			throw new Exception();
		}
		...
		int num6 = val.ReserveRect(512, 512);
		int num7 = val.ReserveRect(512, 512);
		if (num6 != 2048)
		{
			throw new Exception();
		}
		...
		int num8 = val.ReserveRect(8192, 8192);
		int num9 = val.ReserveRect(8192, 8192);
		if (num8 != 1792)
		{
			throw new Exception();
		}
	...
	private void OnEnable()
	{
		...
		Debug.Log((object)m_UberZOrderer.ReserveRect(2048, 512));
		Debug.Log((object)m_UberZOrderer.ReserveRect(2048, 512));
		Debug.Log((object)m_UberZOrderer.ReserveRect(2048, 512));
		Debug.Log((object)m_UberZOrderer.ReserveRect(4096, 4096));
		Debug.Log((object)m_UberZOrderer.ReserveRect(4096, 4096));
		Debug.Log((object)m_UberZOrderer.ReserveRect(512, 512));
		Debug.Log((object)m_UberZOrderer.ReserveRect(512, 512));
	}
