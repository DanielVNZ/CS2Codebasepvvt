...
public class SaveInfo : IJsonWritable, IContentPrerequisite
{
	...
	public void Write(IJsonWriter writer)
	{
		...
		JsonWriterExtensions.Write<SimulationDateTime>(writer, simulationDate);
		writer.PropertyName("options");
		JsonWriterExtensions.Write(writer, (IReadOnlyDictionary<string, bool>)options);
		...
		JsonWriterExtensions.Write(writer, modsEnabled ?? Array.Empty<string>());
