...
public class DeathcareFacilityMode : LocalModePrefab
{
	...
	public override void RecordChanges(EntityManager entityManager, PrefabSystem prefabSystem)
	{
		...
		for (int i = 0; i < m_ModeDatas.Length; i++)
		{
			...
			((EntityManager)(ref entityManager)).GetComponentData<DeathcareFacilityData>(entity);
		}
	}
	...
	public override void ApplyModeData(EntityManager entityManager, PrefabSystem prefabSystem)
	{
		...
		for (int i = 0; i < m_ModeDatas.Length; i++)
		{
			...
			Entity entity = prefabSystem.GetEntity(component.prefab);
			DeathcareFacilityData componentData = ((EntityManager)(ref entityManager)).GetComponentData<DeathcareFacilityData>(entity);
			...
			((EntityManager)(ref entityManager)).SetComponentData<DeathcareFacilityData>(entity, componentData);
		}
	}
