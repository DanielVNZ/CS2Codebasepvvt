...
public class PlaceableObjectGlobalMode : EntityQueryModePrefab
{
	[BurstCompile]
	...
	[Header("Modify the construction cost and XP reward of placeable objects, buildings, excluding zone buildings")]
	public float m_ConstructionCostMultiplier;
