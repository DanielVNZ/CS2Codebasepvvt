...
public class SolarPoweredMode : LocalModePrefab
{
	...
	public override void RecordChanges(EntityManager entityManager, PrefabSystem prefabSystem)
	{
		...
		for (int i = 0; i < m_ModeDatas.Length; i++)
		{
			...
			((EntityManager)(ref entityManager)).GetComponentData<SolarPoweredData>(entity);
		}
	}
	...
	public override void ApplyModeData(EntityManager entityManager, PrefabSystem prefabSystem)
	{
		...
		for (int i = 0; i < m_ModeDatas.Length; i++)
		{
			...
			Entity entity = prefabSystem.GetEntity(component.prefab);
			SolarPoweredData componentData = ((EntityManager)(ref entityManager)).GetComponentData<SolarPoweredData>(entity);
			componentData.m_Production = (int)((float)componentData.m_Production * modeData.m_ProductionMultiplier);
			((EntityManager)(ref entityManager)).SetComponentData<SolarPoweredData>(entity, componentData);
		}
	}
