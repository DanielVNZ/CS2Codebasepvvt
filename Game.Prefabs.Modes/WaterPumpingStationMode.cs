...
public class WaterPumpingStationMode : LocalModePrefab
{
	...
	public override void RecordChanges(EntityManager entityManager, PrefabSystem prefabSystem)
	{
		...
		for (int i = 0; i < m_ModeDatas.Length; i++)
		{
			...
			((EntityManager)(ref entityManager)).GetComponentData<WaterPumpingStationData>(entity);
		}
	}
	...
	public override void ApplyModeData(EntityManager entityManager, PrefabSystem prefabSystem)
	{
		...
		for (int i = 0; i < m_ModeDatas.Length; i++)
		{
			...
			Entity entity = prefabSystem.GetEntity(component.prefab);
			WaterPumpingStationData componentData = ((EntityManager)(ref entityManager)).GetComponentData<WaterPumpingStationData>(entity);
			...
			((EntityManager)(ref entityManager)).SetComponentData<WaterPumpingStationData>(entity, componentData);
		}
	}
