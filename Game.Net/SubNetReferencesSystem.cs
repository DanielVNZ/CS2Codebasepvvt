...
public class SubNetReferencesSystem : GameSystemBase
{
	...
	private struct UpdateSubNetReferencesJob : IJobChunk
	{
		...
		public void Execute(in ArchetypeChunk chunk, int unfilteredChunkIndex, bool useEnabledMask, in v128 chunkEnabledMask)
		{
			...
			if (((ArchetypeChunk)(ref chunk)).Has<Created>(ref m_CreatedType))
			{
				if (((ArchetypeChunk)(ref chunk)).Has<Temp>(ref m_TempType))
				{
					for (int i = 0; i < nativeArray.Length; i++)
					{
						...
						{
							CollectionUtils.TryAddUniqueValue<SubNet>(m_SubNets[owner.m_Owner], new SubNet(subNet));
						}
					}
				}
				else
				{
					for (int j = 0; j < nativeArray.Length; j++)
					{
						...
						CollectionUtils.TryAddUniqueValue<SubNet>(m_SubNets[owner2.m_Owner], new SubNet(subNet2));
					}
				}
				return;
			}
			for (int k = 0; k < nativeArray.Length; k++)
			{
				...
				{
					CollectionUtils.RemoveValue<SubNet>(m_SubNets[owner3.m_Owner], new SubNet(subNet3));
				}
			}
		}
	...
	private struct TypeHandle
	{
		...
		public void __AssignHandles(ref SystemState state)
		{
			...
			__Game_Net_SubNet_RW_BufferLookup = ((SystemState)(ref state)).GetBufferLookup<SubNet>(false);
		}
	}
	...
	protected override void OnCreate()
	{
		...
		array[1] = val;
		m_SubNetQuery = ((ComponentSystemBase)this).GetEntityQuery((EntityQueryDesc[])(object)array);
		((ComponentSystemBase)this).RequireForUpdate(m_SubNetQuery);
	}
	...
	protected override void OnUpdate()
	{
		...
		UpdateSubNetReferencesJob updateSubNetReferencesJob = new UpdateSubNetReferencesJob
		{
			...
			m_SubNets = InternalCompilerInterface.GetBufferLookup<SubNet>(ref __TypeHandle.__Game_Net_SubNet_RW_BufferLookup, ref ((SystemBase)this).CheckedStateRef)
		};
		((SystemBase)this).Dependency = JobChunkExtensions.Schedule<UpdateSubNetReferencesJob>(updateSubNetReferencesJob, m_SubNetQuery, ((SystemBase)this).Dependency);
	}
