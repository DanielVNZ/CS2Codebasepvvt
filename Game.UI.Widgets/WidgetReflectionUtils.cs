...
{
	private static CustomSerializationPolicy kListElementLabelPolicy = new CustomSerializationPolicy("ListElementLabel", true, (Func<MemberInfo, bool>)((MemberInfo info) => info.GetCustomAttribute<ListElementLabelAttribute>() != null && TypeExtensions.GetReturnType(info) == typeof(string)));
	...
	{
		return FormatterUtilities.GetSerializableMembers(type, (ISerializationPolicy)(object)kListElementLabelPolicy).FirstOrDefault();
	}
}
