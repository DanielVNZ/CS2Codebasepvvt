...
public class IntFieldBuilders : IFieldBuilderFactory
{
	...
	public FieldBuilder TryCreate(Type memberType, object[] attributes)
	{
		...
		static object FromVector2Int(int2 value)
		{
			...
			return (object)new Vector2Int(value.x, value.y);
		}
		...
		static int2 ToVector2Int(object value)
		{
			...
			return new int2(((Vector2Int)(ref val)).x, ((Vector2Int)(ref val)).y);
		}
		static int3 ToVector3Int(object value)
		{
			...
			return new int3(((Vector3Int)(ref val)).x, ((Vector3Int)(ref val)).y, ((Vector3Int)(ref val)).z);
		}
	}
