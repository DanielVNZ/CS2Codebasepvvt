...
public class SecondaryObjectReferencesSystem : GameSystemBase
{
	...
	protected override void OnUpdate()
	{
		...
		UpdateSecondaryObjectReferencesJob updateSecondaryObjectReferencesJob = new UpdateSecondaryObjectReferencesJob
		{
		...
		((SystemBase)this).Dependency = JobChunkExtensions.Schedule<UpdateSecondaryObjectReferencesJob>(updateSecondaryObjectReferencesJob, m_ObjectQuery, ((SystemBase)this).Dependency);
	}
