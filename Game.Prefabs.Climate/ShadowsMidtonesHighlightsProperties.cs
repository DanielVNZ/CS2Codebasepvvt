...
{
	public Vector4Parameter m_Shadows = new Vector4Parameter(new Vector4(1f, 1f, 1f, 0f), false);

	public Vector4Parameter m_Midtones = new Vector4Parameter(new Vector4(1f, 1f, 1f, 0f), false);

	public Vector4Parameter m_Highlights = new Vector4Parameter(new Vector4(1f, 1f, 1f, 0f), false);

	[Header("Shadow Limits")]
	public MinFloatParameter m_ShadowsStart = new MinFloatParameter(0f, 0f, false);

	public MinFloatParameter m_ShadowsEnd = new MinFloatParameter(0.3f, 0f, false);

	[Header("Highlight Limits")]
	public MinFloatParameter m_HighlightsStart = new MinFloatParameter(0.55f, 0f, false);

	public MinFloatParameter m_HighlightsEnd = new MinFloatParameter(1f, 0f, false);
