...
{
	public ClampedFloatParameter m_Opacity = new ClampedFloatParameter(1f, 0f, 1f, false);

	public ClampedFloatParameter m_CumulusStrength = new ClampedFloatParameter(1f, 0f, 1f, false);

	public ClampedFloatParameter m_StratusStrength = new ClampedFloatParameter(1f, 0f, 1f, false);

	public ClampedFloatParameter m_CirrusStrength = new ClampedFloatParameter(1f, 0f, 1f, false);

	public ClampedFloatParameter m_WispyStrength = new ClampedFloatParameter(1f, 0f, 1f, false);

	public MinFloatParameter m_Altitude = new MinFloatParameter(2000f, 0f, false);
