...
public class MotionBlurQualitySettings : QualitySetting<MotionBlurQualitySettings>
{
	...
	{
		CreateVolumeComponent<MotionBlur>(profile, ref m_MotionBlurComponent);
	...
	{
		base.Apply();
		if ((Object)(object)m_MotionBlurComponent != (Object)null)
		{
			ApplyState((VolumeParameter<float>)(object)m_MotionBlurComponent.intensity, 0f, !enabled);
			ApplyState((VolumeParameter<int>)(object)m_MotionBlurComponent.m_SampleCount, sampleCount);
		}
	}
