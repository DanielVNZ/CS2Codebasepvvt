...
public class SSGIQualitySettings : QualitySetting<SSGIQualitySettings>
{
	...
	{
		CreateVolumeComponent<GlobalIllumination>(profile, ref m_SSGIComponent);
	...
	{
		base.Apply();
		if ((Object)(object)m_SSGIComponent != (Object)null)
		{
			ApplyState((VolumeParameter<bool>)(object)m_SSGIComponent.enable, enabled);
			ApplyState((VolumeParameter<bool>)(object)m_SSGIComponent.fullResolutionSS, fullscreen);
			ApplyState((VolumeParameter<int>)(object)m_SSGIComponent.m_MaxRaySteps, raySteps);
			ApplyState((VolumeParameter<float>)(object)m_SSGIComponent.m_DenoiserRadiusSS, denoiserRadius);
			ApplyState((VolumeParameter<float>)(object)m_SSGIComponent.depthBufferThickness, depthBufferThickness);
			ApplyState((VolumeParameter<bool>)(object)m_SSGIComponent.m_HalfResolutionDenoiserSS, halfResolutionPass);
			ApplyState((VolumeParameter<bool>)(object)m_SSGIComponent.m_SecondDenoiserPassSS, secondDenoiserPass);
		}
	}
