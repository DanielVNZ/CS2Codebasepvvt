...
public class TerrainQualitySettings : QualitySetting<TerrainQualitySettings>
{
	...
	{
		CreateVolumeComponent<TerrainRendering>(profile, ref m_TerrainRenderingComponent);
	...
	{
		base.Apply();
		if ((Object)(object)m_TerrainRenderingComponent != (Object)null)
		{
			ApplyState((VolumeParameter<int>)(object)m_TerrainRenderingComponent.finalTessellation, finalTessellation);
			ApplyState((VolumeParameter<float>)(object)m_TerrainRenderingComponent.targetPatchSize, (float)targetPatchSize, state: true);
		}
	}
}
