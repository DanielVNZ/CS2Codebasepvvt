...
public class SSAOQualitySettings : QualitySetting<SSAOQualitySettings>
{
	...
	{
		CreateVolumeComponent<ScreenSpaceAmbientOcclusion>(profile, ref m_AOComponent);
	...
	{
		base.Apply();
		if ((Object)(object)m_AOComponent != (Object)null)
		{
			ApplyState((VolumeParameter<float>)(object)m_AOComponent.intensity, 0f, !enabled);
			ApplyState((VolumeParameter<bool>)(object)m_AOComponent.m_FullResolution, fullscreen);
			ApplyState((VolumeParameter<int>)(object)m_AOComponent.m_MaximumRadiusInPixels, maxPixelRadius);
			ApplyState((VolumeParameter<int>)(object)m_AOComponent.m_StepCount, stepCount);
		}
	}
