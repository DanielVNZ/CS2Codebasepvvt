...
public class SSRQualitySettings : QualitySetting<SSRQualitySettings>
{
	...
	{
		CreateVolumeComponent<ScreenSpaceReflection>(profile, ref m_SSRComponent);
	...
	{
		base.Apply();
		if ((Object)(object)m_SSRComponent != (Object)null)
		{
			ApplyState((VolumeParameter<bool>)(object)m_SSRComponent.enabled, enabled);
			ApplyState((VolumeParameter<bool>)(object)m_SSRComponent.enabledTransparent, enabled && enabledTransparent);
			ApplyState((VolumeParameter<int>)(object)m_SSRComponent.m_RayMaxIterations, maxRaySteps);
		}
	}
