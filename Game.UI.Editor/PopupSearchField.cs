...
public class PopupSearchField : Widget, ISettable, IWidget, IJsonWritable
{
	...
	public class Bindings : IWidgetBindingFactory
	{
		...
		{
			yield return (IBinding)(object)new TriggerBinding<IWidget, string, bool>(group, "setSearchFavorite", (Action<IWidget, string, bool>)delegate(IWidget widget, string query, bool favorite)
			{
	...
	protected override void WriteProperties(IJsonWriter writer)
	{
		...
		JsonWriterExtensions.Write<Suggestion>(writer, (IList<Suggestion>)m_Suggestions);
	}
}
