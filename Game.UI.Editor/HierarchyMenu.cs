...
public class HierarchyMenu<T> : HierarchyMenu
{
	...
	protected override void WriteProperties(IJsonWriter writer)
	{
		...
		JsonWriterExtensions.Write<ViewportItem<T>>(writer, (IList<ViewportItem<T>>)m_Viewport);
...
public abstract class HierarchyMenu : Widget
{
	...
	public class Bindings : IWidgetBindingFactory
	{
		...
		{
			yield return (IBinding)(object)new TriggerBinding<IWidget, int, int>(group, "setHierarchyRenderedRange", (Action<IWidget, int, int>)delegate(IWidget widget, int startVisibleIndex, int endVisibleIndex)
			{
			...
			yield return (IBinding)(object)new TriggerBinding<IWidget, int, bool>(group, "setHierarchyItemSelected", (Action<IWidget, int, bool>)delegate(IWidget widget, int viewportIndex, bool selected)
			{
				if (widget is HierarchyMenu hierarchyMenu)
				{
			...
			yield return (IBinding)(object)new TriggerBinding<IWidget, int, bool>(group, "setHierarchyItemExpanded", (Action<IWidget, int, bool>)delegate(IWidget widget, int viewportIndex, bool expanded)
			{
				if (widget is HierarchyMenu hierarchyMenu)
				{
