...
public class LocalizationField : Widget
{
	...
	public class Bindings : IWidgetBindingFactory
	{
		...
		{
			yield return (IBinding)(object)new TriggerBinding<IWidget, int, string, string>(group, "setLocalizationEntry", (Action<IWidget, int, string, string>)delegate(IWidget widget, int index, string localeId, string text)
			{
			...
			yield return (IBinding)(object)new TriggerBinding<IWidget>(group, "addLocalizationEntry", (Action<IWidget>)delegate(IWidget widget)
			{
				if (widget is LocalizationField localizationField)
				{
			...
			yield return (IBinding)(object)new TriggerBinding<IWidget, int>(group, "removeLocalizationEntry", (Action<IWidget, int>)delegate(IWidget widget, int index)
			{
				if (widget is LocalizationField localizationField)
				{
	...
	protected override void WriteProperties(IJsonWriter writer)
	{
		...
		JsonWriterExtensions.Write(writer, GameManager.instance.localizationManager.GetSupportedLocales());
		writer.PropertyName("localization");
		JsonWriterExtensions.Write<LocalizationFieldEntry>(writer, (IList<LocalizationFieldEntry>)m_Localization);
		writer.PropertyName("placeholder");
		JsonWriterExtensions.Write<LocalizedString>(writer, placeholder);
