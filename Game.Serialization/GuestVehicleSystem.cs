...
public class GuestVehicleSystem : GameSystemBase
{
	...
	protected override void OnUpdate()
	{
		...
		GuestVehicleJob guestVehicleJob = new GuestVehicleJob
		{
		...
		((SystemBase)this).Dependency = JobChunkExtensions.Schedule<GuestVehicleJob>(guestVehicleJob, m_Query, ((SystemBase)this).Dependency);
	}
