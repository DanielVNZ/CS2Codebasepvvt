...
public class SpawnLocationElementSystem : GameSystemBase
{
	...
	private struct SpawnLocationElementJob : IJobChunk
	{
		...
		public void Execute(in ArchetypeChunk chunk, int unfilteredChunkIndex, bool useEnabledMask, in v128 chunkEnabledMask)
		{
			...
			for (int i = 0; i < nativeArray2.Length; i++)
			{
				...
				if (m_SpawnLocationElements.TryGetBuffer(owner.m_Owner, ref val))
				{
					val.Add(new SpawnLocationElement(spawnLocation, type));
				}
	...
	protected override void OnUpdate()
	{
		...
		SpawnLocationElementJob spawnLocationElementJob = new SpawnLocationElementJob
		{
			...
			m_SpawnLocationElements = InternalCompilerInterface.GetBufferLookup<SpawnLocationElement>(ref __TypeHandle.__Game_Buildings_SpawnLocationElement_RW_BufferLookup, ref ((SystemBase)this).CheckedStateRef)
		};
		((SystemBase)this).Dependency = JobChunkExtensions.Schedule<SpawnLocationElementJob>(spawnLocationElementJob, m_Query, ((SystemBase)this).Dependency);
	}
