...
public class RandomLocalizationSystem : GameSystemBase
{
	...
	private struct EnsureLocalizationJob : IJobChunk
	{
		...
		public void Execute(in ArchetypeChunk chunk, int unfilteredChunkIndex, bool useEnabledMask, in v128 chunkEnabledMask)
		{
			...
			BufferAccessor<RandomLocalizationIndex> bufferAccessor = ((ArchetypeChunk)(ref chunk)).GetBufferAccessor<RandomLocalizationIndex>(ref m_RandomLocalizationType);
			...
			for (int i = 0; i < nativeArray.Length; i++)
			{
				...
				Entity val2 = nativeArray2[i].m_Prefab;
				if (m_SpawnableBuildingDatas.HasComponent(val2))
				{
					val2 = m_SpawnableBuildingDatas[val2].m_ZonePrefab;
				}
				if (m_LocalizationCounts.TryGetBuffer(val2, ref counts))
				{
					Random random = m_RandomSeed.GetRandom(1 + val.Index);
	...
	protected override void OnUpdate()
	{
		...
		EnsureLocalizationJob ensureLocalizationJob = new EnsureLocalizationJob
		{
			m_EntityType = InternalCompilerInterface.GetEntityTypeHandle(ref __TypeHandle.__Unity_Entities_Entity_TypeHandle, ref ((SystemBase)this).CheckedStateRef),
			m_PrefabRefType = InternalCompilerInterface.GetComponentTypeHandle<PrefabRef>(ref __TypeHandle.__Game_Prefabs_PrefabRef_RO_ComponentTypeHandle, ref ((SystemBase)this).CheckedStateRef),
			m_RandomLocalizationType = InternalCompilerInterface.GetBufferTypeHandle<RandomLocalizationIndex>(ref __TypeHandle.__Game_Common_RandomLocalizationIndex_RW_BufferTypeHandle, ref ((SystemBase)this).CheckedStateRef),
		...
		((SystemBase)this).Dependency = JobChunkExtensions.Schedule<EnsureLocalizationJob>(ensureLocalizationJob, m_Query, ((SystemBase)this).Dependency);
	}
