...
public class AvailabilitySystem : GameSystemBase
{
	...
	private struct AvailabilityJob : IJobChunk
	{
		...
		public void Execute(in ArchetypeChunk chunk, int unfilteredChunkIndex, bool useEnabledMask, in v128 chunkEnabledMask)
		{
			...
			for (int i = 0; i < ((ArchetypeChunk)(ref chunk)).Count; i++)
			{
				...
				while (val.Length < 34)
				{
					val.Add(new ResourceAvailability
					{
						m_Availability = float2.op_Implicit(0f)
					});
				}
			}
		}
	...
	protected override void OnCreate()
	{
		...
		base.OnCreate();
		m_Query = ((ComponentSystemBase)this).GetEntityQuery((ComponentType[])(object)new ComponentType[1] { ComponentType.ReadOnly<ResourceAvailability>() });
	...
	protected override void OnUpdate()
	{
		...
		AvailabilityJob availabilityJob = new AvailabilityJob
		{
			m_AvailabilityType = InternalCompilerInterface.GetBufferTypeHandle<ResourceAvailability>(ref __TypeHandle.__Game_Net_ResourceAvailability_RW_BufferTypeHandle, ref ((SystemBase)this).CheckedStateRef)
		};
		((SystemBase)this).Dependency = JobChunkExtensions.ScheduleParallel<AvailabilityJob>(availabilityJob, m_Query, ((SystemBase)this).Dependency);
	}
