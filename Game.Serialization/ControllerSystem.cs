...
public class ControllerSystem : GameSystemBase
{
		...
		public void Execute(in ArchetypeChunk chunk, int unfilteredChunkIndex, bool useEnabledMask, in v128 chunkEnabledMask)
		{
			...
			for (int i = 0; i < bufferAccessor.Length; i++)
			{
				...
				for (int j = 0; j < val.Length; j++)
				{
					...
					{
						Controller controller2 = m_ControllerData[vehicle];
						controller2.m_Controller = controller;
						m_ControllerData[vehicle] = controller2;
					}
				}
			}
		}
	...
	protected override void OnCreate()
	{
		...
		//IL_0026: Unknown result type (might be due to invalid IL or missing references)
		base.OnCreate();
		m_Query = ((ComponentSystemBase)this).GetEntityQuery((ComponentType[])(object)new ComponentType[1] { ComponentType.ReadOnly<LayoutElement>() });
	...
	protected override void OnUpdate()
	{
		...
		ControllerJob controllerJob = new ControllerJob
		{
		...
		((SystemBase)this).Dependency = JobChunkExtensions.Schedule<ControllerJob>(controllerJob, m_Query, ((SystemBase)this).Dependency);
	}
