...
public class SearchSystem : GameSystemBase, IPreDeserialize
{
	...
	private struct UpdateSearchTreeJob : IJobChunk
	{
		...
		public void Execute(in ArchetypeChunk chunk, int unfilteredChunkIndex, bool useEnabledMask, in v128 chunkEnabledMask)
		{
			...
			{
				NativeArray<Block> nativeArray2 = ((ArchetypeChunk)(ref chunk)).GetNativeArray<Block>(ref m_BlockType);
				for (int j = 0; j < nativeArray.Length; j++)
				{
					Entity val2 = nativeArray[j];
					Bounds2 val3 = ZoneUtils.CalculateBounds(nativeArray2[j]);
					m_SearchTree.Add(val2, val3);
				}
			}
			else
			{
				NativeArray<Block> nativeArray3 = ((ArchetypeChunk)(ref chunk)).GetNativeArray<Block>(ref m_BlockType);
				for (int k = 0; k < nativeArray.Length; k++)
				{
					Entity val4 = nativeArray[k];
					Bounds2 val5 = ZoneUtils.CalculateBounds(nativeArray3[k]);
					m_SearchTree.Update(val4, val5);
				}
			}
		}
	...
	protected override void OnCreate()
	{
		...
		array[0] = val;
		m_UpdatedBlocksQuery = ((ComponentSystemBase)this).GetEntityQuery((EntityQueryDesc[])(object)array);
		m_AllBlocksQuery = ((ComponentSystemBase)this).GetEntityQuery((ComponentType[])(object)new ComponentType[2]
		{
			ComponentType.ReadOnly<Block>(),
			ComponentType.Exclude<Temp>()
		});
		m_SearchTree = new NativeQuadTree<Entity, Bounds2>(1f, (Allocator)4);
	}
	...
	protected override void OnUpdate()
	{
		...
		EntityQuery val = (loaded ? m_AllBlocksQuery : m_UpdatedBlocksQuery);
