...
public class BlockReferencesSystem : GameSystemBase
{
		...
		public void Execute(in ArchetypeChunk chunk, int unfilteredChunkIndex, bool useEnabledMask, in v128 chunkEnabledMask)
		{
			...
			if (((ArchetypeChunk)(ref chunk)).Has<Created>(ref m_CreatedType))
			{
				for (int i = 0; i < nativeArray.Length; i++)
				{
					...
					CollectionUtils.TryAddUniqueValue<SubBlock>(m_Blocks[owner.m_Owner], new SubBlock(block));
				}
			}
			else
			{
				for (int j = 0; j < nativeArray.Length; j++)
				{
					...
					CollectionUtils.RemoveValue<SubBlock>(m_Blocks[owner2.m_Owner], new SubBlock(block2));
				}
			}
		}
	...
	protected override void OnCreate()
	{
		...
		((ComponentSystemBase)this).RequireForUpdate(m_BlockQuery);
	}
	...
	protected override void OnUpdate()
	{
		...
		UpdateBlockReferencesJob updateBlockReferencesJob = new UpdateBlockReferencesJob
		{
			...
			m_Blocks = InternalCompilerInterface.GetBufferLookup<SubBlock>(ref __TypeHandle.__Game_Zones_SubBlock_RW_BufferLookup, ref ((SystemBase)this).CheckedStateRef)
		};
		((SystemBase)this).Dependency = JobChunkExtensions.Schedule<UpdateBlockReferencesJob>(updateBlockReferencesJob, m_BlockQuery, ((SystemBase)this).Dependency);
	}
