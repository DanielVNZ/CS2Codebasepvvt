...
public class InputBindingField : Field<ProxyBinding>, IWarning
{
	public class Bindings : IWidgetBindingFactory
	{
		...
		{
			yield return (IBinding)(object)new TriggerBinding<IWidget>(group, "rebindInput", (Action<IWidget>)delegate(IWidget widget)
			{
			...
			yield return (IBinding)(object)new TriggerBinding<IWidget>(group, "unsetInputBinding", (Action<IWidget>)delegate(IWidget widget)
			{
			...
			yield return (IBinding)(object)new TriggerBinding<IWidget>(group, "resetInputBinding", (Action<IWidget>)delegate(IWidget widget)
			{
				InputBindingField bindingField = widget as InputBindingField;
				if (bindingField != null)
				{
	...
	{
		base.valueWriter = (IWriter<ProxyBinding>)(object)new ValueWriter<ProxyBinding>();
	}
	...
	protected override void WriteProperties(IJsonWriter writer)
	{
		...
		JsonWriterExtensions.Write<ProxyBinding>(writer, m_Value.conflicts);
	}
}
