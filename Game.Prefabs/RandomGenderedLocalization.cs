...
public class RandomGenderedLocalization : RandomLocalization
{
	...
	protected override int GetLocalizationCount()
	{
		...
		{
			ComponentBase.baseLog.WarnFormat((Object)(object)base.prefab, "All gendered localization IDs should have the same variation count: {0} ({1}), {2} ({3}), {4} ({5})", new object[6] { m_LocalizationID, localizationCount, m_MaleID, localizationIndexCount, m_FemaleID, localizationIndexCount2 });
		}
		return num;
	}
}
