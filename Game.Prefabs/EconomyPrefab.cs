...
public class EconomyPrefab : PrefabBase
{
	...
	[Tooltip("The building relocation cost multiplier.")]
	...
	[Tooltip("Min max loan interest rate")]
	...
	public override void LateInitialize(EntityManager entityManager, Entity entity)
	{
		...
		((EntityManager)(ref entityManager)).SetComponentData<EconomyParameterData>(entity, new EconomyParameterData
		{
