...
public class AssetCollection : ScriptableObject
{
	...
	public void AddPrefabsTo(PrefabSystem prefabSystem)
	{
		...
		{
			prefabSystem.AddPrefab(prefab, ((Object)this).name);
		}
	...
	{
		m_Prefabs.Sort((PrefabBase a, PrefabBase b) => string.Compare(((Object)a).name, ((Object)b).name, StringComparison.Ordinal));
	}
}
